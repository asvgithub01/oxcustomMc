...
public class MotionService extends Service implements SensorEventListener {
    ...
    private static final int NO_MOVE_COUNTER_TO_STOP = 250; //250 unos 30sg de inactividad// 50;//50*0.5segunods=250 sg no move for stop services
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            ...
            //valores superiores hacen q el motion no se detecte bien los moves
        }
        else
        {
    ...
    private void startServices() {
        saveIsStopped(false);
        //Orchextra.start();
        Intent i = new Intent(this.getApplicationContext(), OrchextraBackgroundService.class);
